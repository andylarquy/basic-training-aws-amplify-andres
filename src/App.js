...
class App extends Component {
  constructor(props) {
    super(props)
    this.state = { content: "", title: "", list: [], item: {}, showDetails: false }
  }
    ...
    <div className="container">
      <form onSubmit={this.handleSubmit}>
        ...
        <div className="form-group">
          ...
          <input type="text" className="form-control" id="title" placeholder="Title" value={this.state.title} onChange={this.handleChange} />
        </div>
        <div className="form-group">
      ...
      {this.state.showDetails ?
        (<Detail item={this.state.item} loadListPage={this.loadListPage} delete={this.delete} />) :
